    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        start_btn.setOnClickListener {
            ...
            if (isRunning) {
               ...
               var  millisInFuture = total_zaman_calisma!! * 1000
        ...
        restart_btn.setOnClickListener {
            ...
            total_zaman_calisma!!.toInt().toLong()
            var millisInFuture: Long = total_zaman_calisma!! * 1000
            timerCalisma(millisInFuture, countDownInterval).start()
        }
    ...
    private fun timerCalisma(millisInFuture: Long, countDownInterval: Long): CountDownTimer {
        ...
        return object : CountDownTimer(millisInFuture, countDownInterval) {
            ...
            override fun onFinish() {
                ...
                var millisInFuture = total_zaman_dinlenme!!*1000
